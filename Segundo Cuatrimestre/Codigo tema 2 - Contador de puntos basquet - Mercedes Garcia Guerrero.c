Algoritmo ConsignaTemaBasquetball
	Definir equipo1puntos,equipo2puntos,simples,dobles,triples Como Entero
	equipo1puntos <- 0
	equipo2puntos <- 0
	simples <- 0
	dobles <- 0
	...
	Mientras Verdadero Hacer
		Repetir
			Escribir 'Ingresar número de equipo (1 o 2)'
			Leer equipo
		...
		Repetir
			Escribir 'Ingresar valor del punto'
			Leer puntos
